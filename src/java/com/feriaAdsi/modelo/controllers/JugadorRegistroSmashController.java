 ...
 * @author APRENDIZ
 */
@Named(value = "jugadorRegistroSmashController")
@RequestScoped
public class JugadorRegistroSmashController {
    ...
    public JugadorRegistroSmashController() {
    }
    
    @PostConstruct
    public void init(){
    //Lista torneo hace la busqueda de los torneos por ese nombre     
    listaTorneos = tfl.findByTipo("Super Smash Bros 64");
